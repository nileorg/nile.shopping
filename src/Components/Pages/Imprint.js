            ...
            <Layout.Row>
              <Layout.Col className="" span="24">
                <Fade left>
                  ...
                  for the management of the Sebastian Heußer. The use of the
                  Internet pages of the Sebastian Heußer is possible without any
                  ...
                  protection regulations applicable to the Sebastian Heußer.
                  ...
                  <p>As the controller, the Sebastian Heußer has implemented
                  ...
                  <h2>1. Definitions</h2>
                  <p>The data protection declaration of the Sebastian Heußer is
                  ...
                  <p>In this data protection declaration, we use, inter alia,
                  ...
                  <ul style={{listStyle: 'none', padding: 0}}>
                    <Fade left>
                      ...
                      <li>
                        <h3>e) Profiling</h3>
                        <p>Profiling means any form of automated processing of
                      ...
                      <li>
                        ...
                        <p>Pseudonymisation is the processing of personal data in
                      ...
                      <li>
                        ...
                        <p>Controller or controller responsible for the processing
                      ...
                      <li>
                        <h3>j) Third party</h3>
                        <p>Third party is a natural or legal person, public
                  ...
                  <Fade left>
                    ...
                    related to data protection is:</p>

                    <p>Sebastian Heußer</p>
                    <p>Collingstraße 104</p>
                    <p>66424 Homburg</p>
                    <p>Deutschland</p>
                    <p>Phone: 015731801694</p>
                    <p>Email: sehe89@gmail.com</p>
                    <p>Website: home.nile.community</p>

                    <h2>3. Collection of general data and information</h2>
                    <p>The website of the Sebastian Heußer collects a series of
                    ...
                    Sebastian Heußer does not draw any conclusions about the data
                    ...
                    with the information necessary for criminal prosecution in
                    case of a cyber-attack. Therefore, the Sebastian Heußer analyzes
                    anonymously collected data and information statistically,
                    with the aim of increasing the data protection and data
                    security of our enterprise, and to ensure an optimal level of
                    protection for the personal data we process. The anonymous data
                    of the server log files are stored separately from all personal
                    ...
                    regulations to which the controller is subject to.</p>
                    ...
                    blocked or erased in accordance with legal requirements.</p>
                    ...
                    <Fade left>
                      ...
                      <li>
                        ...
                        <ul style={{listStyle: 'none', padding: 0}}>
                          ...
                          <li>the recipients or categories of recipients to whom
                          the personal data have been or will be disclosed, in
                          particular recipients in third countries or international
                          organisations;</li>
                          <li>where possible, the envisaged period for which the
                          personal data will be stored, or, if not possible, the
                          criteria used to determine that period;</li>
                          <li>the existence of the right to request from the
                          controller rectification or erasure of personal data, or
                          restriction of processing of personal data concerning
                          the data subject, or to object to such processing;</li>
                          <li>the existence of the right to lodge a complaint with
                          a supervisory authority;</li>
                          <li>where the personal data are not collected from the
                          data subject, any available information as to their
                          source;</li>
                          <li>the existence of automated decision-making,
                          including profiling, referred to in Article 22(1) and
                          (4) of the GDPR and, at least in those cases, meaningful
                        ...
                        <p>Furthermore, the data subject shall have a right to
                        ...
                        <p>If a data subject wishes to avail himself of this right
                      ...
                      <li>
                        ...
                        of providing a supplementary statement.</p>
                      ...
                      <li>
                        ...
                        <ul style={{listStyle: 'none', padding: 0}}>
                          <li>The personal data are no longer necessary in relation
                          to the purposes for which they were collected or otherwise
                          processed.</li>
                          <li>The data subject withdraws consent to which the
                          processing is based according to point (a) of Article 6(1)
                          of the GDPR, or point (a) of Article 9(2) of the GDPR,
                          and where there is no other legal ground for the
                          processing.</li>
                          <li>The data subject objects to the processing pursuant
                          to Article 21(1) of the GDPR and there are no overriding
                          legitimate grounds for the processing, or the data subject
                          objects to the processing pursuant to Article 21(2) of
                          the GDPR.</li>
                          <li>The personal data have been unlawfully processed.</li>
                          <li>The personal data must be erased for compliance with
                          a legal obligation in Union or Member State law to which
                          the controller is subject.</li>
                          <li>The personal data have been collected in relation to
                          the offer of information society services referred to in
                          Article 8(1) of the GDPR.</li>
                        </ul>

                        <p>If one of the aforementioned reasons applies, and a data
                        subject wishes to request the erasure of personal data
                        stored by the Sebastian Heußer, he or she may, at any time,
                        contact any employee of the controller. An employee of
                        Sebastian Heußer shall promptly ensure that the erasure
                        request is complied with immediately.</p>

                        <p>Where the controller has made personal data public and
                        ...
                        processing is not required. An employees of the Sebastian
                        Heußer will arrange the necessary measures in individual
                        cases.</p>
                      </li>
                      <li>
                        ...
                        of processing where one of the following applies:</p>

                        <ul style={{listStyle: 'none', padding: 0}}>
                          <li>The accuracy of the personal data is contested by the
                          data subject, for a period enabling the controller to
                          verify the accuracy of the personal data. </li>
                          <li>The processing is unlawful and the data subject
                          opposes the erasure of the personal data and requests
                          instead the restriction of their use instead.</li>
                          <li>The controller no longer needs the personal data for
                          the purposes of the processing, but they are required by
                          the data subject for the establishment, exercise or
                          defence of legal claims.</li>
                          <li>The data subject has objected to processing pursuant
                          to Article 21(1) of the GDPR pending the verification
                          whether the legitimate grounds of the controller override
                          those of the data subject.</li>
                        </ul>

                        <p>If one of the aforementioned conditions is met, and a
                        data subject wishes to request the restriction of the
                        processing of personal data stored by the Sebastian Heußer,
                        he or she may at any time contact any employee of the
                        controller. The employee of the Sebastian Heußer will
                      ...
                      <li>
                        ...
                        He or she shall have the right to transmit those data to
                        another controller without hindrance from the controller
                        to which the personal data have been provided, as long as
                        the processing is based on consent pursuant to point (a) of
                        Article 6(1) of the GDPR or point (a) of Article 9(2) of
                        the GDPR, or on a contract pursuant to point (b) of
                        Article 6(1) of the GDPR, and the processing is carried
                        ...
                        <p>In order to assert the right to data portability, the
                      ...
                      <li>
                        ...
                        or her particular situation, at any time, to processing of
                        ...
                        <p>The Sebastian Heußer shall no longer process the
                        ...
                        <p>If the Sebastian Heußer processes personal data for
                        direct marketing purposes, the data subject shall have the
                        right to object at any time to processing of personal
                        data concerning him or her for such marketing. This applies
                        to profiling to the extent that it is related to such direct
                        marketing. If the data subject objects to the Sebastian
                        Heußer to the processing for direct marketing purposes, the
                        Sebastian Heußer will no longer process the personal data for
                        these purposes.</p>
                        ...
                        Sebastian Heußer for scientific or historical research
                        ...
                        subject may contact any employee of the Sebastian Heußer.
                      ...
                      <li>
                        <h3>h) Automated individual decision-making, including
                        profiling</h3>
                        ...
                        <p>If the decision (1) is necessary for entering into, or
                        the performance of, a contract between the data subject
                        and a data controller, or (2) it is based on the data
                        subject's explicit consent, the Sebastian Heußer shall
                        ...
                        <p>If the data subject wishes to exercise the rights
                        concerning automated individual decision-making, he or she
                        may, at any time, contact any employee of the Sebastian
                        Heußer.</p>
                      </li>
                      <li>
                        ...
                        withdraw the consent, he or she may, at any time, contact
                        any employee of the Sebastian Heußer.</p>
                      </li>
                    </Fade>
                  </ul>
                  <Fade left>
                    ...
                    another natural person. This would be the case, for example,
                    if a visitor were injured in our company and his name, age,
                    health insurance data or other vital information would have to
                    be passed on to a doctor, hospital or other third party. Then
                    the processing would be based on Art. 6(1) lit. d GDPR.
                    Finally, processing operations could be based on Article 6(1)
                    lit. f GDPR. This legal basis is used for processing operations
                    which are not covered by any of the abovementioned legal grounds,
                    if processing is necessary for the purposes of the legitimate
                    ...
                    <h2>7. The legitimate interests pursued by the controller or
                    by a third party</h2>
                    ...
                    fulfillment of the contract or the initiation of a contract.</p>

                    <h2>9. Provision of personal data as statutory or contractual
                    ...
                    of the personal data would have the consequence that the
                    ...
                    <p>
                      ...
                      <a href="https://www.wbs-law.de/eng/">
                        German Lawyers
                      </a> from WILDE BEUGER SOLMECKE, Cologne.
                    </p>
                  </Fade>
              </Layout.Col>
            </Layout.Row>
