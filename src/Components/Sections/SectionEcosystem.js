        ...
        <Layout.Col span="8" className="center">
          <Flip left>
            <div className="card">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <a class="el-button" href="https://vendor-demo.nile.community" target="_blank">Demo</a>
            </div>
          </Flip>
        </Layout.Col>
        <Layout.Col span="8" className="center">
        ...
        <Layout.Col span="8" className="center">
          <Flip left>
            <div className="card">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <a class="el-button" href="https://customer-demo.nile.community" target="_blank">Demo</a>
            </div>
          </Flip>
        </Layout.Col>
      </Layout.Row>
